...
def can_be_found_updated_and_saved
  ...
  replace = Movie.find_by(title:"Awesome Flick")
  replace.update(title: "Even Awesomer Flick")
  replace.save
end
...
def can_update_using_update_method
  ...
  replace = Movie.find_by(title: "Wat?")
  replace.update_title("Wat, huh?")
  # replace.update(title: "Wat, huh?")
end
